...
const Herosection = () => {
  return (
    <section
      id="home"
      className="container flex flex-col md:flex-row justify-between items-center mx-auto pt-24 pb-6 px-4 sm:px-6 lg:px-8"
    >
      <div className="w-full md:w-1/2 space-y-8">
        ...
        <div className="flex items-center gap-0 md:gap-4">
          ...
          />
          <button className="h-[54px] md:h-14 px-8 bg-blue-500 text-white rounded-r-xl md:rounded-xl rounded-l-none md:rounded-l-xl hover:bg-blue-600 transition-all hover:shadow-lg hover:shadow-blue-500">
            →
          </button>
        </div>
      </div>
